...
static bool InstallSystemExtension()
{
    ...
    NSLog(@"extensionBundle: %@", [extensionBundle bundleURL]);
    
    OSSystemExtensionRequest *request                                  = [OSSystemExtensionRequest activationRequestForExtension:[extensionBundle bundleIdentifier] queue:dispatch_get_main_queue()];
